...
def test_choose_next_model_waits_without_failure():
    ...
    comments = [make_comment(1, "2026-09-03T12:00:00Z", MODULE.build_review_request_comment("claude-sonnet-5", "head"))]
    model, reason = MODULE.choose_next_model(config, "head", comments, {"claude-sonnet-5": 0, "claude-fable-5": 0})
...
def test_choose_next_model_falls_back_after_unsupported_model_error():
    config = MODULE.OrchestratorConfig("claude-sonnet-5", ("claude-fable-5", "gpt-5.5"))
    request = make_comment(1, "2026-09-03T12:00:00Z", MODULE.build_review_request_comment("claude-sonnet-5", "head"))
...
def test_choose_next_model_exhausts_allowlist():
    config = MODULE.OrchestratorConfig("claude-sonnet-5", ("claude-fable-5",))
    comments = [
        make_comment(1, "2026-09-03T12:00:00Z", MODULE.build_review_request_comment("claude-sonnet-5", "head")),
        ...
        make_comment(3, "2026-09-03T12:02:00Z", MODULE.build_review_request_comment("claude-fable-5", "head")),
...
def test_recent_model_failures_counts_only_supported_copilot_errors():
    ...
    comments = [
        ...
        make_comment(3, "2026-09-02T01:00:00Z", 'Copilot error: Error: Model "claude-sonnet-5" is not available.'),

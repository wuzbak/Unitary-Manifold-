...
## The Unitary Manifold v9.0 — Step-by-Step Upload Instructions
...
3. Now create a **GitHub Release** (tag `v9.0`) and Zenodo will automatically archive it and mint a DOI.
...
> Tip: zip the whole repo: `git archive --format=zip HEAD -o unitary-manifold-v9.0.zip`
...
**Title:**
```
The Unitary Manifold: A 5D Gauge Geometry of Emergent Irreversibility (Version 9.0)
```

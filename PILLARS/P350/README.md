...
*(One-sentence claim — see `docs/mas_tracker.yml` for the full description of Pillar 350.)*

## Navigation

- **Source module(s):** `src/core/pillar350_ftum_basin_theorem.py`
- **Test file(s):** `tests/test_pillar350_ftum_basin_theorem.py`
- **Theory doc:** *(none yet — see `PILLARS/README.md` for derivation references)*
- **Registry entry:** [`docs/mas_tracker.yml`](../../docs/mas_tracker.yml) — search for `pillar: 350`

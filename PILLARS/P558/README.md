...
*(One-sentence claim — see `docs/mas_tracker.yml` for the full description of Pillar 558.)*

## Navigation

- **Source module(s):** `src/core/pillar558_gen1_cl_ab_derived.py`
- **Test file(s):** `tests/test_pillar558_gen1_cl_ab_derived.py`
- **Theory doc:** *(none yet — see `PILLARS/README.md` for derivation references)*
- **Registry entry:** [`docs/mas_tracker.yml`](../../docs/mas_tracker.yml) — search for `pillar: 558`

...
*(One-sentence claim — see `docs/mas_tracker.yml` for the full description of Pillar 552.)*

## Navigation

- **Source module(s):** `src/core/pillar552_arxiv_ledger_sync.py`
- **Test file(s):** `tests/test_pillar552_arxiv_ledger_sync.py`
- **Theory doc:** *(none yet — see `PILLARS/README.md` for derivation references)*
- **Registry entry:** [`docs/mas_tracker.yml`](../../docs/mas_tracker.yml) — search for `pillar: 552`

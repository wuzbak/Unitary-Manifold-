...
*(One-sentence claim — see `docs/mas_tracker.yml` for the full description of Pillar 352.)*

## Navigation

- **Source module(s):** `src/core/pillar352_swampland_nw_bound.py`
- **Test file(s):** `tests/test_pillar352_swampland_nw_bound.py`
- **Theory doc:** *(none yet — see `PILLARS/README.md` for derivation references)*
- **Registry entry:** [`docs/mas_tracker.yml`](../../docs/mas_tracker.yml) — search for `pillar: 352`

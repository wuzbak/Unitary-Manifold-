...
*(One-sentence claim — see `docs/mas_tracker.yml` for the full description of Pillar 589.)*

## Navigation

- **Source module(s):** `src/core/pillar589_np_bc4_certificate.py`
- **Test file(s):** `tests/test_pillar589_np_bc4_certificate.py`
- **Theory doc:** *(none yet — see `PILLARS/README.md` for derivation references)*
- **Registry entry:** [`docs/mas_tracker.yml`](../../docs/mas_tracker.yml) — search for `pillar: 589`

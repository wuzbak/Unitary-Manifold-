...
*(One-sentence claim — see `docs/mas_tracker.yml` for the full description of Pillar 333.)*

## Navigation

- **Source module(s):** `src/core/pillar333_kk_baryogenesis.py`
- **Test file(s):** `tests/test_pillar333_kk_baryogenesis.py`
- **Theory doc:** *(none yet — see `PILLARS/README.md` for derivation references)*
- **Registry entry:** [`docs/mas_tracker.yml`](../../docs/mas_tracker.yml) — search for `pillar: 333`

# Pillar 546 — fermion_orbifold_cl
...
*(One-sentence claim — see `docs/mas_tracker.yml` for the full description of Pillar 546.)*

## Navigation

- **Source module(s):** `src/core/pillar546_fermion_orbifold_cl.py`
- **Test file(s):** `tests/test_pillar546_fermion_orbifold.py`
- **Theory doc:** *(none yet — see `PILLARS/README.md` for derivation references)*
- **Registry entry:** [`docs/mas_tracker.yml`](../../docs/mas_tracker.yml) — search for `pillar: 546`

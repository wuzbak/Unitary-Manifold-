...
| 15 | `src/cold_fusion/` | φ-enhanced Gamow tunneling in Pd lattice; coherence volume; COP and anomalous heat as falsifiable predictions | 215 |
...
**Total Pentad tests: 1266 · Total repository tests: 15,023 passed / 15,035 collected**

## Quick Reference — Running All Suites

```bash
python -m pytest tests/ -q                    # 12601 passed (Pillars 1–74 core)
...
# → 15023 passed, 2 skipped, 0 failed
```

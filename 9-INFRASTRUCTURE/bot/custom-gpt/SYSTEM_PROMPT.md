...
**Axiom I — No lies.**  
The repository is computationally verified: 42,215 tests across all suites (tests/ + recycling/ + 5-GOVERNANCE/Unitary Pentad/ + omega/), 0 failures.  Every
...
| "All 142 pillars + Ω₀" | `NATURAL_SCIENCES.md`, `REVIEW_CONCLUSION.md`, `LEGEND.md` |
...
Tests:
  ...
  # Grand total: 18057 passed · 329 skipped · 0 failures

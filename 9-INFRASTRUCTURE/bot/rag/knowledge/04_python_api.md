...
test suite has **29 425 passing tests** (full suite: `tests/` + `recycling/` + `5-GOVERNANCE/Unitary Pentad/`; 329 skipped, 11 deselected, 0 failures). Core modules use NumPy/SciPy only; optional integrations include JAX (GPU/AD), Lean4 (formal proofs), Z3 (SMT bounds), and XDiag (quantum many-body bridge).

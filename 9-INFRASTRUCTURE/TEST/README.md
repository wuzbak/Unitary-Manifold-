...
Canonical full regression (STATUS.md): **62,525 passed · 48 skipped · 12 deselected · 0 failed** (v34.0, Sprint BL, 2026-09-02; tests/ + recycling/ + Pentad).
...
python3 -m pytest tests/ recycling/ "5-GOVERNANCE/Unitary Pentad/" -q  # full suite — 62,525 passed
```

Expected result (default):

```
62,525 passed · 48 skipped · 12 deselected · 0 failed (canonical v34.0 / Sprint BL full regression)
```

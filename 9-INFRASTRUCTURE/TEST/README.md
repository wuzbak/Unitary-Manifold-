...
Canonical full regression (STATUS.md): **45,900 passed · 22 skipped · 12 deselected · 0 failed** (v15.9, 2026-06-05; tests/ + recycling/ + Pentad).
...
python3 -m pytest tests/ recycling/ "5-GOVERNANCE/Unitary Pentad/" -q  # full suite — 45,900 passed
```

Expected result (default):

```
45,900 passed · 22 skipped · 12 deselected · 0 failed (canonical v15.9 full-deps checkpoint)
```

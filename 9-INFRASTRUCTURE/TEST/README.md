...
Canonical full regression (STATUS.md): **56,964 passed · 47 skipped · 12 deselected · 0 failed** (v22.11, 2026-08-20; tests/ + recycling/ + Pentad).
...
python3 -m pytest tests/ recycling/ "5-GOVERNANCE/Unitary Pentad/" -q  # full suite — 45,726 passed
```

Expected result (default):

```
46,885 passed · 23 skipped · 12 deselected · 0 failed (canonical v15.8 full-deps checkpoint)
```

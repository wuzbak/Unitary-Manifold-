...
Canonical full regression (STATUS.md): **45,517 passed · 22 skipped · 12 deselected · 0 failed** (v15.0, 2026-05-26; tests/ + recycling/ + Pentad).
...
python3 -m pytest tests/ recycling/ "5-GOVERNANCE/Unitary Pentad/" -q  # full suite — 45,517 passed
```

Expected result (default):

```
45,517 passed · 22 skipped · 12 deselected · 0 failed (canonical v15.0 full-deps checkpoint)
```

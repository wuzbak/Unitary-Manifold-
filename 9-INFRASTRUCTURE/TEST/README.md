...
Canonical full regression (STATUS.md): **34 280 passed · 393 skipped · 12 deselected · 0 failed**.
...
python3 -m pytest tests/ recycling/ "5-GOVERNANCE/Unitary Pentad/" -q  # full suite — 34,280 passed
```

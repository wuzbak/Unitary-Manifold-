...
Canonical full regression (STATUS.md): **46,088 passed · 2 skipped · 12 deselected · 0 failed** (v15.0, 2026-05-26; tests/ + recycling/ + Pentad).
...
python3 -m pytest tests/ recycling/ "5-GOVERNANCE/Unitary Pentad/" -q  # full suite — 46,088 passed
```

Expected result (default):

```
46,088 passed · 2 skipped · 12 deselected · 0 failed (canonical v15.0 full-deps checkpoint)
```

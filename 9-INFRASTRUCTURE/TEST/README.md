...
> Canonical regression marker: 63,709 passed · 23 skipped · 12 deselected · 0 failed.

Canonical full regression (STATUS.md): **63,709 passed · 23 skipped · 12 deselected · 0 failed** (v35.5, Sprint BY, 2026-09-04; tests/ + recycling/ + Pentad).
...
*(tests/ suite: ≥ 27,600 passed, 75 skipped + recycling/: 316 + 5-GOVERNANCE/Unitary Pentad/: ~1,487 passed, 254 skipped)*
...
python3 -m pytest tests/ recycling/ "5-GOVERNANCE/Unitary Pentad/" -q  # full suite — 63,544 passed
```

Expected result (default):

```
63,544 passed · 23 skipped · 12 deselected · 0 failed (canonical v34.9 / Sprint BL full regression)
```
...
| **Total (tests/ suite)** | **~16,002** | **~15,926 fast passed · 76 skipped · 11 slow deselected · 0 failures** |

...
def conservative_promotion_ladder() -> List[Dict[str, object]]:
    ...
    # P16 is now GEOMETRIC_PREDICTION (v10.32). Remaining open: P26(+0.3), P27(+0.7), P28(+0.7)
    after_open_parameter_closures = CURRENT_SCORE + 0.3 + 0.7 + 0.7
    ...
    return [
        {
            ...
            "parameters": ["P26", "P27", "P28"],
            "score_delta_if_closed": 1.7,
            ...
            "note": "P16 closed in v10.32 via WS-III T²/Z₃ +52 derivation.",
        },
        {
            ...
            "reason": (
                "Even perfect closure of P26/P27/P28 reaches 23.2/28, still below 90%. "

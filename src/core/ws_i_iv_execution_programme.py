...
WS_EXECUTION_PROGRAMME: Dict[str, Dict] = {
    ...
    "WS-III": {
        ...
        "execution_artifact": "src/sixd/neutrino_full_geometry_6dplus.py",
        "test_artifact": "tests/test_sixd_neutrino_full_geometry_6dplus.py",
        "status": "PASS_FREEZE",
        "outcome": "Simultaneous Δm²₂₁/Δm²₃₁ 6D+ treatment delivered within bounded residual gates.",
        "post_freeze_action": "frozen",
        "recycle_into_mas": False,
    },
    "WS-I": {
        "order": 3,
        "parameter_target": "P5",
        "execution_artifact": "src/sixd/higgs_radion_full_geometry_6dplus.py",
        "test_artifact": "tests/test_sixd_higgs_radion_full_geometry_6dplus.py",
        "status": "PASS_FREEZE",
        "outcome": "6D+ brane-localized ξ_{6D} treatment yields perturbative θ_HR and bounded Higgs residual.",
        "post_freeze_action": "frozen",
        "recycle_into_mas": False,
    },
    "WS-IV": {
        "order": 4,
        "parameter_target": "P3",
        "execution_artifact": "src/tend/cy3_full_moduli_flux_alpha_s_10d.py",
        "test_artifact": "tests/test_tend_cy3_full_moduli_flux_alpha_s_10d.py",
        "status": "PASS_FREEZE",
        "outcome": "10D CY₃ full moduli/flux treatment yields α_s(M_Z) within precision residual gate.",
        "post_freeze_action": "frozen",
        "recycle_into_mas": False,
    },
}

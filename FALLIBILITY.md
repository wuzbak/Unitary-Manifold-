...
The 837 automated tests (826 fast-selected + 11 slow-deselected) in `tests/` confirm that the numerical implementations
...
When the README badge reads "826 passed · 1 skipped · 0 failed," this is a statement about

...
The 749 automated tests (738 fast-selected + 11 slow-deselected) in `tests/` confirm that the numerical implementations
...
|-------|--------|-----------|
| 737 passed · 1 skipped (guard) · 0 failed (749 total) | ✅ Confirmed | Internal consistency only; 1 guard skip on immediate convergence is correct behaviour |

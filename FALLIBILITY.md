...
The 256 automated tests in `tests/` confirm that the numerical implementations
...
When the README badge reads "256/256 Tests Passing," this is a statement about
...
|-------|--------|-----------|
| 256/256 tests pass | ✅ Confirmed | Internal consistency only |

...
def _build_registry() -> Dict[str, LanguageManifest]:
    ...
    langs = [
        ...
        L("Lua",     F.SCRIPTING, P.MULTI, T.DYNAMIC_STRONG, M.GC_TRACING, C.CONCURRENT,
          [".lua"], ["function","local","end","do","repeat","until","table","coroutine"], 16, gc=0.5, safety=0.55, par=0.5),
        L("Bash",    F.SHELL_DEVOPS, P.IMPERATIVE, T.UNTYPED, M.STACK_ONLY, C.CONCURRENT,
        ...
        L("Mercury", F.LOGIC, P.MULTI, T.STATIC_STRONG, M.GC_TRACING, C.CONCURRENT,
        ...
        L("VHDL",    F.DOMAIN, P.CONCURRENT, T.STATIC_STRONG, M.MANUAL, C.CONCURRENT,
          [".vhd",".vhdl"], ["architecture","entity","signal","process","component","port","map","std_logic"], 63, gc=0.0, safety=0.75, par=0.99),
        L("Verilog", F.DOMAIN, P.CONCURRENT, T.STATIC_STRONG, M.MANUAL, C.CONCURRENT,

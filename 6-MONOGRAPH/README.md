# 6-MONOGRAPH — The Book and Formal Paper

This folder contains the primary published theory document, the arXiv submission,
...
Predictions from Braided Kaluza-Klein Geometry"

The paper covers: the 5D metric ansatz, topological constraint on n_w, the
braid algebra (k_CS derivation, c_s = 12/37), CMB predictions (nₛ, r, β),
the LiteBIRD falsification window (0.058° gap), and open problems.

**Explicitly excluded from the paper:** consciousness, biology, cold fusion,
governance, theology, education, and economics.  These are not hidden —
they are in `4-IMPLICATIONS/` and `7-OUTREACH/` with full documentation.

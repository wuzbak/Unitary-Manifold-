...
- [x] `zenodo/.zenodo.json` — updated to v9.27, 15,023 tests, 99 pillars — CLOSED, expanded keywords (note: v9.28 adds sub-pillars 70-C, 99-B, 15-F)
...
(v9.28: 15,096 passing tests; 330 skipped = 76 dual-use + 254 Pentad product stubs)
```

**Comments field:**
```
74 pages, 0 figures. 99 pillars + sub-pillars — CLOSED. Numerical implementation (15,096 tests) at
https://github.com/wuzbak/Unitary-Manifold-

...
| **Test suite** | `pytest` unit tests — **~21,055 passed · 329 skipped · 11 slow-deselected · 0 failures** (tests/ + recycling/ + 5-GOVERNANCE/Unitary Pentad/ + omega/). **~21,055** — all 182 pillars + Ω₀ + sub-pillars passing. |

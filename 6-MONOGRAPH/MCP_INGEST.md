...
**Canonical status (v29.0): Full regression: **61,261 passed · 45 skipped · 12 deselected · 0 failed** (internal mathematical self-consistency). Sprint BE narrows the remaining internal residual set: PMNS ordering proxy is closed at NLO stability, KK-tower ISW is closed as Boltzmann-negligible, and the checked-in open set remains CKM 13D texture, CMB peak amplitude, F-theory Rung 10 residual blockers, DESI DR3 monitoring, LiteBIRD birefringence, and non-perturbative QG. For canonical truth-sync use `docs/CLAIM_MASTER_BOARD.md`, `docs/TRUTH_LAYER.md`, and `docs/GATEKEEPER_SUMMARY.md`.
...
│   # Total: 60,196 passed · 45 skipped · 12 deselected · 0 failures (v23.2, 2026-08-20)
...
| **Test suite** | `pytest` unit tests — **61,261 passed · 45 skipped · 12 deselected · 0 failed** (tests/ + recycling/ + 5-GOVERNANCE/Unitary Pentad/). |

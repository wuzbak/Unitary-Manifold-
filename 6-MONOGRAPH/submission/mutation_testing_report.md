...
## Unitary Manifold — v20.1 (2026-08-01)
...
**Grand total:** ~49,850 tests passing (23 skipped, 12 deselected, 0 failures)
on the un-mutated codebase (v20.1 canonical; historical baseline at v13.4: 42,215).
...
The ~49,850-test suite is **adversarially robust**: every documented physical

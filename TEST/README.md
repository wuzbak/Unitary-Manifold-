...
**748 tests: 737 passed · 1 skipped (guard) · 11 slow-deselected · 0 failures** — verified 2026-04-12, Python 3.12, pytest 9.0.3
...
```
737 passed, 1 skipped, 11 deselected in ~42s
```
...
| `tests/test_derivation.py` | 59 | KK derivation chain, field equations, Walker–Pearson EOM, information current |
...
| **Total** | **748** | **737 fast passed · 1 skipped (guard) · 11 slow deselected · 0 failures** |

...
# Expected: ~40,526 passed · 1 skipped · 12 deselected · 0 failed
...
| **Total (current)** | **Grand total: ~40,526 passed · 1 skipped · 12 deselected · 0 failed** (see `STATUS.md` and `README.md` for full per-file breakdown) |

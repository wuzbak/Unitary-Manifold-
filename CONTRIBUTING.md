...
# Expected: 36 522 passed · 414 skipped · 12 deselected · 0 failed
...
| **Total (current)** | **Grand total: 36 522 passed · 414 skipped · 12 deselected · 0 failed** (see `STATUS.md` and `README.md` for full per-file breakdown) |

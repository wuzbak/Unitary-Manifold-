...
python -m pytest tests/ -v          # 737 passed, 1 skipped (guard), 11 deselected (slow)
...
| Derivation chain | KK derivation, field equations, Walker–Pearson EOM, information current (59 tests) |
...
| **Total** | **748: 737 fast passed · 1 skipped (guard) · 11 slow-deselected · 0 failed** |

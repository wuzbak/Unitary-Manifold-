...
# Expected: 32 536 passed · 393 skipped · 12 deselected · 0 failed
...
| **Total (current)** | **Grand total: 32 536 passed · 393 skipped · 12 deselected · 0 failed** (see `STATUS.md` and `README.md` for full per-file breakdown) |

...
# Expected: 39,952 passed · 22 skipped · 12 deselected · 0 failed
...
| **Total (current)** | **Grand total: 39,952 passed · 22 skipped · 12 deselected · 0 failed** (see `STATUS.md` and `README.md` for full per-file breakdown) |

...
# Expected: 38,513 passed · 22 skipped · 12 deselected · 0 failed
...
| **Total (current)** | **Grand total: 38,513 passed · 22 skipped · 12 deselected · 0 failed** (see `STATUS.md` and `README.md` for full per-file breakdown) |

...
| **P5** | CMB acoustic peak amplitude | A_s | Suppressed ×4.2–6.1 vs ΛCDM (α_GW Casimir target band 4.2e-10–4.8e-10; v10.41 10D hardgate benchmark gives α_GW≈4.49e-10) | Planck, CMB-S4 | ~2030 | 🟢 CLOSED_WITH_10D_HARDGATE_BENCHMARK — framework closure achieved; 5D-only derivation remains explicitly open and retained as the limitation note | 2026-05-09 | Maintain closed status under hardgate policy; preserve the retained 5D limitation note and re-open only if future 10D consistency gates fail |

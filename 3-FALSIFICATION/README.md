...
| [**BRAID_FALSIFIER_PACKET.md**](BRAID_FALSIFIER_PACKET.md) | **Braid-lane empirical packet** — one place for LiteBIRD sector discrimination, the β gap, and the linked \(r\)/\(n_s\) pressure tests. |
...
## Adversarial Reviews Folder

The [`ADVERSARIAL_REVIEWS/`](ADVERSARIAL_REVIEWS/README.md) subfolder
consolidates all adversarial review rounds in one place, with a clear
separation between:

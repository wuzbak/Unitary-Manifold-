...
664 tests: 652 fast passed · 1 skipped (guard, not a failure) · 11 slow-deselected · 0 failures. Suite covers metric, evolution, boundary, fixed-point, inflation/CMB, arrow of time, CMB landscape, end-to-end pipeline, observational resolution, closure consistency, fuzzing, dimensional reduction, discretization invariance, parallel validation, and Richardson temporal convergence.

...
For readers who want hard entry points rather than summaries, start with the repository at [github.com/wuzbak/Unitary-Manifold-](https://github.com/wuzbak/Unitary-Manifold-), then the local orientation path [`README.md`](../../../../README.md), [`proof/README.md`](../../../../proof/README.md), and [`notebooks/01_quickstart.ipynb`](../../../../notebooks/01_quickstart.ipynb). The enduring citation remains the Zenodo DOI (`https://doi.org/10.5281/zenodo.19584531`), and the executable verification path remains `python -m pytest tests/ recycling/ "5-GOVERNANCE/Unitary Pentad/" -q` alongside the falsification ledger at [`3-FALSIFICATION/FALSIFICATION_REGISTER.md`](../../../../3-FALSIFICATION/FALSIFICATION_REGISTER.md).
---

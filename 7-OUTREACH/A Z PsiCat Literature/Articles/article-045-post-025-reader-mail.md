...
For readers who want hard entry points rather than summaries, start with the repository at [github.com/wuzbak/Unitary-Manifold-](https://github.com/wuzbak/Unitary-Manifold-), then the local orientation path [`README.md`](../../../../README.md), [`proof/README.md`](../../../../proof/README.md), and [`docs/navigation/REPOSITORY_MAP.md`](../../../../docs/navigation/REPOSITORY_MAP.md); [`notebooks/01_quickstart.ipynb`](../../../../notebooks/01_quickstart.ipynb) is the optional hands-on next stop after that. The enduring citation remains the Zenodo DOI (`https://doi.org/10.5281/zenodo.19584531`), and the executable verification path remains `python -m pip install -r requirements.txt` followed by `python -m pytest tests/ recycling/ "5-GOVERNANCE/Unitary Pentad/" -q` alongside the falsification ledger at [`3-FALSIFICATION/FALSIFICATION_REGISTER.md`](../../../../3-FALSIFICATION/FALSIFICATION_REGISTER.md).
---

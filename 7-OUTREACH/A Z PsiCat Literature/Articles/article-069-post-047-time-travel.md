# Time Travel: What the Framework Permits and What It Forbids — Merlin/PsiCat v1 Rewrite

*Merlin/PsiCat Rewrite v1 · Series/Season One*  
*Written: 2026-09-15T05:41:03Z*  
*AxiomZero Technologies & Consulting, SPC commissioned work: Edited and written by PsiCat Ai.*
*Grounded rewrite source: `/7-OUTREACH/substack/posts/post-047-time-travel.md`*
...
General relativity permits closed timelike curves — paths through spacetime that return to their own starting point in both space and time. The most famous example is the Gödel metric (1949): a solution to Einstein's equations describing a rotating universe in which any two events can be connected by a future-directed timelike curve.
---

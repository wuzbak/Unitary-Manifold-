...
In the language of the framework, a stable governance system is one that has a fixed point — a state that the system tends toward despite perturbations — and in which the feedback loops that drive the system toward that fixed point are operative.
---

# The Topology Proof — How Boundary Conditions Select the Vacuum — Merlin/PsiCat v1 Rewrite

*Merlin/PsiCat Rewrite v1 · Series/Season One*  
*Written: 2026-09-15T05:41:03Z*  
*AxiomZero Technologies & Consulting, SPC commissioned work: Edited and written by PsiCat Ai.*
*Grounded rewrite source: `/7-OUTREACH/substack/posts/post-082-aps-topology-vacuum.md`*
...
The key quantity in the theorem is the **eta invariant** η̄ — a spectral asymmetry that measures the imbalance between positive and negative eigenvalues of the boundary Dirac operator. If the spectrum of the boundary operator is symmetric around zero, η̄ = 0. If it is asymmetric, η̄ is non-zero.
---

...
The **formalist/constructivist** position: mathematics is a formal game played by rules humans invented. Its success in describing physics is explained by selection — we try many mathematical structures and keep the ones that work. The universe doesn't care about mathematics; we just use math to describe the universe because that's the kind of language we have.
---

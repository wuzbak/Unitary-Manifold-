...
| Topic | Grounded summary |
|---|---|
| Core idea | 5D Kaluza–Klein geometry aimed at irreversibility / arrow-of-time structure |
| Front door | `README.md` |
| Current status | `STATUS.md`, `docs/mas_tracker.yml`, `docs/TRUTH_LAYER.md` |
| Hard limits and non-claims | `FALLIBILITY.md` |
| Primary proof gate | `proof/TIER_1_FORMAL.md` |
| Primary external falsifier | LiteBIRD-era birefringence window/gap test |
| Branch-history marker | 64,150 passed · 22 skipped · 18 deselected · 0 failed |
| Governance boundary | Pentad independent of physics correctness |
| Public-outreach lane | `7-OUTREACH/` |
...
| Folder | Role |
|---|---|
| `1-THEORY/` | derivations, theorem registry, claim status |
| `2-REPRODUCIBILITY/` | runs and validation reports |
| `3-FALSIFICATION/` | predictions and failure conditions |
| `5-GOVERNANCE/` | Unitary Pentad governance framework |
| `6-MONOGRAPH/` | monograph and manuscript source material |

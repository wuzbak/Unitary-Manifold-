...
| 7.0 — SynBio Edition | April 2026 | Pillar 25 extended with `src/genetics/synthetic_biology.py` (10 φ-functions, 63 new tests, 141 total in test_genetics.py); biosecurity HILS governance added to Unitary Pentad (`pentad_scenarios.py`); post-27.a (filed as post-97) added; total tests 15,096 |

...
class MerlinDndService:
    ...
    def add_character_to_campaign(self, campaign_id: str, payload: dict) -> Character:
        ...
        self.get_campaign(campaign_id).characters.append(character)
        return character
    ...
    def add_quest(self, campaign_id: str, payload: dict) -> Quest:
        ...
        self.get_campaign(campaign_id).quests.append(quest)
        return quest
    ...
    def add_layout(self, campaign_id: str, payload: dict) -> DungeonLayout:
        ...
        self.get_campaign(campaign_id).layouts.append(layout)
        return layout
    ...
    def merlin_query(self, campaign_id: str, prompt: str) -> dict:
        return build_merlin_response(self.export_campaign(campaign_id)["campaign"], prompt)

...
"""Launch the PsiCat DM Guide & Player Assistant local API."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Serve the PsiCat D&D assistant product.")
    ...
    if args.mode == "demo":
        demo = {
            ...
            "features": [
                ...
                "PsiCat table assistant",
            ],
        }
        print(json.dumps(demo, indent=2))
        return 0

    print("PsiCat DM Guide & Player Assistant (Product 23)")

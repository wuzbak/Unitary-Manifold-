...
- `POST /api/psicat/training-cycle` now also emits an automatic Lane E performance-gate verdict and promotion blockers derived from retained before/after performance receipts.

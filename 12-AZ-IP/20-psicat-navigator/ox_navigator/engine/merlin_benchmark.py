...
STAGE_C_BENCHMARK_CORPUS: list[dict[str, Any]] = [
    ...
    {
        "id": "stage_c_arc_agi_shadow_integration",
        "stage": "stage_c_capability_expansion",
        "track": "arc_agi_abstraction_generalization",
        "query": "Before adding ARC-AGI into PsiCat training, explain the shadow-eval, contamination-control, and fail-closed promotion rules that must stay in force.",
        "keywords": ["arc-agi", "shadow", "eval", "contamination", "promotion"],
        "minimum_keyword_hits": 2,
        "required_gates": ["ARCHITECTURE_LIMIT", "GOVERNANCE"],
        "required_contract_sections": ["FOLLOWUPS:", "Sources:"],
        "required_provenance_kinds": ["policy", "knowledge_base"],
        "review_focus": ["shadow_eval_discipline", "holdout_protection", "promotion_fail_closed"],
        "benchmark_mode": "single_turn",
    },
    {

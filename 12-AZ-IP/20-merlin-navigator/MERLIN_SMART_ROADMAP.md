...
5. Run receipts from the Merlin folder (`cd 12-AZ-IP/20-merlin-navigator && pip install -r requirements.txt && python tools/run_merlin_stage_a_benchmarks.py --json`)

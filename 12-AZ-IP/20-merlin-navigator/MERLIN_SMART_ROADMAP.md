...
5. Run receipts (`pip install -r 12-AZ-IP/20-merlin-navigator/requirements.txt && python 12-AZ-IP/20-merlin-navigator/tools/run_merlin_stage_a_benchmarks.py --json`)

...
contextBridge.exposeInMainWorld('psicatBrowser', {
  ...
  updateWorkspaceLayout: (layout, secondaryTabId) => ipcRenderer.invoke('browser:update-workspace-layout', layout, secondaryTabId),
  saveWorkspace: (name) => ipcRenderer.invoke('browser:save-workspace', name),
  applyWorkspace: (workspaceId) => ipcRenderer.invoke('browser:apply-workspace', workspaceId),
  ...
  syncPull: () => ipcRenderer.invoke('browser:sync-pull'),

...
"""Launch the PhiCat DM Guide & Player Assistant local API."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Serve the PhiCat D&D assistant product.")
    ...
    if args.mode == "demo":
        demo = {
            ...
            "features": [
                ...
                "PhiCat table assistant",
            ],
        }
        print(json.dumps(demo, indent=2))
        return 0

    print("PhiCat DM Guide & Player Assistant (Product 23)")

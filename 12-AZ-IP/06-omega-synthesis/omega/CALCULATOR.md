...
| `version` | str | 'v20.1' | Framework version string. |
| `n_pillars | int | 406 | Number of completed pillars (406 total as of v13.1; hardgate core: 208; adjacent tracks: Pillars 218–254+). |
| `n_tests` | int | ~49,850 | Passing test count reported in OmegaReport (~49,850 as of v20.1). |
...
report.version              # str    'v20.1'
report.n_pillars            # int    406
report.n_tests_passing      # int    ~49,850
...
*CALCULATOR.md — omega/ — v20.1 — 2026-08-01*  

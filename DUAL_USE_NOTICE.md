# Ethical-Use Notice — Unitary Manifold

**Document version:** 2.0 — May 2026  
**Author / rights holder:** ThomasCory Walker-Pearson  
**Repository:** https://github.com/wuzbak/Unitary-Manifold-  
**Cross-references:** [`LICENSE`](LICENSE) · [`LICENSE-AGPL`](LICENSE-AGPL) · [`LEGAL.md`](LEGAL.md)
...
> remains irrevocably public domain under DPC v1.0).
...
## Part I — Prohibited Applications
...
holder to add "Further Restrictions" that include "Preservation of Notices".
This notice, once included in any copy or derivative work, must be preserved
under AGPL-3.0 § 7(b).

---

## Part II — Biosecurity Note (Synthetic Biology)
...
Unitary Pentad includes a `biosecurity_dual_use_risk()` scenario.
...
## Part III — Relationship to Open Licenses

| License | Effect |
|---------|--------|
| **DPC v1.0** | Theory is irrevocably public domain.  No restriction on equations, derivations, or theoretical content. |
| **AGPL-3.0** | Software is open-source copyleft.  All implementations are public. |

---

## Part IV — Contact

To report a suspected Prohibited Application or ask a question:

- **GitHub Issues:** https://github.com/wuzbak/Unitary-Manifold-/issues
- **Rights holder:** ThomasCory Walker-Pearson (`@wuzbak`)

...
- P417 2-Loop KK Yukawa Jarlskog Closure: **TWOOLOOP_SUBLEADING_ADMISSION7_CLOSED**. The explicit two-loop KK Yukawa correction gives δc_L^(2-loop)/Δc≈2.4×10⁻⁴, more than 200× smaller than the LO δ_KT≈0.053, so Admission 7 is formally CLOSED.

...
examination of the status of 14,641 automated assertions as evidence — what they
prove, what they don't prove, and how they fit into the broader evidential structure
that science requires.*

---

The repository has 14,641 automated tests that pass. Every time someone runs
...
Passing 14,641 tests does not mean the theory is correct.
...
the test suite. "14,641 tests" is not shorthand for "14,641 pieces of evidence that
the theory is right." It is shorthand for "14,641 verifications that the code

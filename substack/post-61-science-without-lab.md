...
The repository has 12,950 automated tests that pass. Every time someone runs
...
Passing 12,950 tests does not mean the theory is correct.
...
the test suite. "12,950 tests" is not shorthand for "12,950 pieces of evidence that
the theory is right." It is shorthand for "12,950 verifications that the code

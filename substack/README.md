...
| `Unitary Pentad/README.md`, `src/justice/`, `src/governance/` | Post 73 |
| All posts 00–73, `FALLIBILITY.md`, `predictions.md` | Post 74 |
...
Three full-length investigative books, all cross-referenced to the numbered posts above.
The Axiom Journalism AI has been moved to a separate private repository — see
[axiom-journalist-app.md](axiom-journalist-app.md) for a description.
...
| `axiom-journalist-app.md` | **App Description** | AXIOM Investigative Journalist AI — high-level description (full source in private repo) |
...
See [BOOKS_README.md](BOOKS_README.md) for full details on each book.

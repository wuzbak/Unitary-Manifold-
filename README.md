# The The Unitary Manifold — 5D Kaluza-Klein Physics Framework (v32.1)
...
[![~61,896 passed · 0 failed (internal self-consistency)](https://img.shields.io/badge/tests-~61%2C896%20passed%20%C2%B7%200%20failed%20%28internal%20self--consistency%29-brightgreen)](tests/)
...
[![Version](https://img.shields.io/badge/version-v32.1-blue)](docs/mas_tracker.yml)
...
> **Current status (v32.1):** Framework is internally self-consistent.
> Full regression: **61,896 passed · 45 skipped · 12 deselected · 0 failed** (tests/ + recycling/ + Pentad; 2026-09-01, v32.1).

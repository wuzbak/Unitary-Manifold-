# The Unitary Manifold — 5D Kaluza-Klein Physics Framework (v15.4)
...
[![46,076 passed · 0 failed](https://img.shields.io/badge/tests-46%2C076%20passed%20%C2%B7%200%20failed-brightgreen)](tests/)
[![507+ pillars + Ω₀ | see STATUS.md](https://img.shields.io/badge/pillars-507%2B%20%2B%20%CE%A9%E2%82%80%20%7C%20see%20STATUS.md-gold)](STATUS.md)
[![Version](https://img.shields.io/badge/version-v15.4-blue)](docs/mas_tracker.yml)
...
> ⚠️ **Honest status (v15.4):** ToE is **28.0/28 (100%)** — P28 cosmological constant promoted to DERIVED via `src/core/p28_lambda_derived_cert.py` (RS1+KK+10D first-principles formula; zero free parameters; factor-of-2 across 122 orders). P502 exposes the machine-readable completion audit; P503–P506 execute stewardship priorities 2–5, and P507 certificates the 5D-KK/P8/PMNS/L2γ/Lean4/CCR/ER=EPR proof lanes without hardgate score inflation.
> Latest focused proof-lane regression on this branch: **233 passed · 0 failed** for P295/P455/P491/P456/P503/P504/P507. Latest full regression: **46,076 passed · 2 skipped · 12 deselected · 0 failed** (v15.4, tests/ + recycling/ + Pentad; 2026-06-01).

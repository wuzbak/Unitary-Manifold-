# The Unitary Manifold — 5D Kaluza-Klein Physics Framework (v15.5)
...
[![508+ pillars + Ω₀ | see STATUS.md](https://img.shields.io/badge/pillars-508%2B%20%2B%20%CE%A9%E2%82%80%20%7C%20see%20STATUS.md-gold)](STATUS.md)
[![Version](https://img.shields.io/badge/version-v15.5-blue)](docs/mas_tracker.yml)
...
> ⚠️ **Honest status (v15.5):** ToE is **28.0/28 (100%)** — P28 cosmological constant promoted to DERIVED via `src/core/p28_lambda_derived_cert.py` (RS1+KK+10D first-principles formula; zero free parameters; factor-of-2 across 122 orders). P502 exposes the machine-readable completion audit; P503–P506 execute stewardship priorities 2–5, P507 certificates the 5D-KK/P8/PMNS/L2γ/Lean4/CCR/ER=EPR proof lanes without hardgate score inflation, and P508 makes the explicit no-claim / earned-yes boundary executable.
> Latest focused claim-boundary regression on this branch: **21 passed · 0 failed** for P507/P508. Latest full regression: **46,088 passed · 2 skipped · 12 deselected · 0 failed** (v15.5, tests/ + recycling/ + Pentad; 2026-06-01).

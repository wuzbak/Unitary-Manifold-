# The Unitary Manifold — 5D Kaluza-Klein Physics Framework (v13.5)
...
[![42,658 passed · 0 failed](https://img.shields.io/badge/tests-42%2C658%20passed%20%C2%B7%200%20failed-brightgreen)](tests/)
...
[![Version](https://img.shields.io/badge/version-v13.5-blue)](docs/mas_tracker.yml)
...
> ⚠️ **Honest status (v13.5):** ToE is **28.0/28 (100%)** — P28 cosmological constant promoted to DERIVED via `src/core/p28_lambda_derived_cert.py` (RS1+KK+10D first-principles formula; zero free parameters; factor-of-2 across 122 orders).
> Latest verified sprint regression on this branch: **42,658 passed · 0 failed**.
...
**Grand total (v13.5): 42,658 passed · 0 failed** (tests/ + recycling/ sprint suite)

**42,658** — 427 pillars + Ω₀ Holon Zero + sub-pillars, 0 failures. ToE score: **28/28 = 100%**. (Historical milestones: v13.4: 42,215; v10.4: ~23,524; v9.39: 21,319; v9.38: 21,165; v9.36: 21,055; v9.34: 20,329; v9.33: 20,249; v9.30: 18,057; v9.29: 15,615.)
...
> 🔒 **Repository extended to 427+ pillars + Ω₀ — v13.5, May 2026.**
...
### Run the test suite — 0 failures (full suite: 42,215 passed · 2 skipped · 12 deselected; v13.5 sprint: 42,658 passed)
...
# Grand total (v13.5, 2026-05-25):
================================ 42,215 passed · 2 skipped · 12 deselected · 0 failed ================================
# (CI #220 baseline, 2026-05-25; v13.5 sprint adds 443 tests → 42,658 total in-sprint)
```

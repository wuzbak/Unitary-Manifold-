...
[![748 Tests: 737 Pass / 1 Skip / 0 Fail](https://img.shields.io/badge/tests-737%20passed%20%C2%B7%201%20skipped%20%C2%B7%200%20failed-brightgreen)](tests/)
...
### Run the test suite — 0 failures (748 tests: 737 passed · 1 skipped · 11 slow-deselected)

```bash
python -m pytest tests/ -v
```

Expected output (737 fast tests pass, 1 skips via guard, 11 slow tests deselected by default):
...
================================ 737 passed, 1 skipped, 11 deselected ================================
```
...
(**748 tests: 737 passed, 1 skipped (guard), 11 slow-deselected, 0 failures**).
...
| F-5 | GR limit (internal) | `pytest` (748 tests: 737 pass · 1 skip · 11 slow-deselected) | Any non-zero GR-limit residual |
